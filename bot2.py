...
stopuser = {}
token = '7426457767:AAHmLpK8k4JZdfGMPtHhZ4d8ubMiMLpK6lQ'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/R_O_L_I_X_5")
...
𝒀𝑶𝑼𝑹 𝑷𝑳𝑨𝑵 𝑵𝑶𝑾 {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗝𝗢𝗜𝗡 ✨", url="https://t.me/R_O_L_I_X_5")
		keyboard.add(contact_button)
...
𝘽𝙤𝙩 𝘽𝙮 @R_O_L_I_X_5''', reply_markup=mes)
